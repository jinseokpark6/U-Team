...
/**
 ...
 @param addressBarViewController The `ATLAddressBarViewController` in which the tap occurred.
 */
- (void)addressBarViewControllerDidSelectWhileDisabled:(ATLAddressBarViewController *)addressBarViewController didTapBarWhileDisabled: (UIButton *)addContactsButton;
